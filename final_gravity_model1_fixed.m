...
%t and c are Legendre Gaussian quadrature points for numerical integration
    ...
    zz2=zz1;
    %adding noise to anomaly having 0 mean and sqrt(0.1) standard deviation 
...
c1=1.4; c2=1.7; 
            ...
            save error_energy_mode1_fixed_w best_error -ascii
...
%%%%    Plotting the results for Optimization model    %%%%
 ...
 %Printing the RMSE error for depth and gravity profile 
    ...
    %plot(pc(1,:),pc(2,:),'.')  
     ...
     %title('Relative Misfit in PCA space Model-1 (fixed density), noise free data ')
     title('Relative Misfit in PCA space Model-1 (fixed density), noisy data ')
