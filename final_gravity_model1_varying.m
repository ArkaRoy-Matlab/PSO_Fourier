...
c1=1.4; c2=1.7; 
            ...
            %save error_energy_model1_varying_wo best_error -ascii
            save error_energy_model1_varying_w best_error -ascii
...
%%%%    Plotting the results for Optimization model    %%%%
 ...
 %Printing the RMSE error for depth and gravity profile 
    ...
    %plot(pc(1,:),pc(2,:),'.')  
     ...
     %title('Relative Misfit in PCA space Model-1 varying density, noise free data ')
     title('Relative Misfit in PCA space Model-1 varying density, noisy data ')
